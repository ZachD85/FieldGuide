...
- [x] Recheck the shadow collection with an English-only IFU, a guideline/consensus document, and a conventional research paper.
...
- [x] API/security cleanup: rotate exposed keys, remove hard-coded secrets, use environment/secret management, restrict Firebase/Drive permissions, and review Firestore rules.
